...
@interface ECQRCodeScanVC ()<AVCaptureMetadataOutputObjectsDelegate>
...
- (void)setupScanningQRCode {
    AVAuthorizationStatus authStates = [AVCaptureDevice authorizationStatusForMediaType:AVMediaTypeVideo];
    if (authStates == AVAuthorizationStatusDenied || authStates == AVAuthorizationStatusRestricted) {
        YYAlertController *alert = [YYAlertController alertControllerWithTitle:@"无法使用相机" message:@"请在“设置-隐私-相机”选项中允许访问你的相机" preferredStyle:UIAlertControllerStyleAlert];
